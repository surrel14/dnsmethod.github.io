...
1. Open _[this link](https://khoindvn.io.vn/document/DNS/ESignCert.zip)_ and save the _.zip_ file somewhere in your _Files_ app. Open the _Files_ app to the directory you saved the _.zip_ file and simply click on it to unzip it
